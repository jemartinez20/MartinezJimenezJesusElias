...
/*vamos a crear una matriz que represente las posiciones del rompecabezas resuelto de 
forma correcta y otra matriz con la base original*/
...
//necesitamos una funcion que se encarge de saber si gane
...
/*
debo integrar una funcion que sirva para poder intercambiar las posiciones de las piezas 
...
/*
ahora viene la parte del movimiento de las piezas, derivado a que tenemos que simular 
que se mueve o intercambia la posicion de cada pieza respecto de la pieza vacia, eso se 
debe de representar con el movimiento de las flechas de navegacion identificando que las 
teclas son: arriba(38), abajo(40), izquierda(37), derecha(39).
*/
...
function moverEnDireccion(direccion){
    ...
    if(posicionValida(nuevaFilaPiezaVacia, nuevaColumnaPiezaVacia)){
        intercambiarPosicioines(filaVacia, columnaVacia, nuevaFilaPiezaVacia, nuevaColumnaPiezaVacia);
...
function intercambiarPosicioines(fila1, columna1, fila2, columna2){
    //intercambio las posiciones de la pieza
    var pieza1 = rompe[fila1][columna1];
    var pieza2 = rompe[fila2][columna2];

    intercambiarPosicioinesRompe(fila1, columna1, fila2, columna2);
...
function intercambiarPosicionesDOM(idPieza1, idPieza2){
    ...
    var elementoPieza1 = document.getElementsById(idPieza1);
    var elementoPieza2 = document.getElementsById(idPieza2);
...
//saber que teclas estan oprimiendo el jugador
